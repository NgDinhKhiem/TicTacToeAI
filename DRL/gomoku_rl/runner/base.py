...
class Runner(abc.ABC):
    def __init__(self, cfg: DictConfig) -> None:
        ...
        if black_checkpoint := cfg.get("black_checkpoint", None):
            if black_checkpoint and os.path.exists(black_checkpoint):
                ...
                logging.warning(f"black_checkpoint not found: {black_checkpoint}, starting from scratch")
        if white_checkpoint := cfg.get("white_checkpoint", None):
            if white_checkpoint and os.path.exists(white_checkpoint):
                ...
                logging.warning(f"white_checkpoint not found: {white_checkpoint}, starting from scratch")
